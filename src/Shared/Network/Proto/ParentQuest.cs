...
namespace Weedwacker.Shared.Network.Proto {
    ...
    static ParentQuestReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "cHJvdG8aG1BhcmVudFF1ZXN0UmFuZG9tSW5mby5wcm90byKnBAoLUGFyZW50",
            "UXVlc3QSTwoTaW5mZXJlbmNlX3BhZ2VfbGlzdBgFIAMoCzIyLldlZWR3YWNr",
            "ZXIuU2hhcmVkLk5ldHdvcmsuUHJvdG8uSW5mZXJlbmNlUGFnZUluZm8SEQoJ",
            "cXVlc3RfdmFyGAcgAygFEh8KF2N1dHNjZW5lX2VuY3J5cHRpb25fa2V5GAsg",
            "ASgEEhoKEnBhcmVudF9xdWVzdF9zdGF0ZRgPIAEoDRJLCgtyYW5kb21faW5m",
            "bxgJIAEoCzI2LldlZWR3YWNrZXIuU2hhcmVkLk5ldHdvcmsuUHJvdG8uUGFy",
            "ZW50UXVlc3RSYW5kb21JbmZvEhcKD3BhcmVudF9xdWVzdF9pZBgDIAEoDRIR",
            "Cglpc19yYW5kb20YDCABKAgSRQoQY2hpbGRfcXVlc3RfbGlzdBgIIAMoCzIr",
            "LldlZWR3YWNrZXIuU2hhcmVkLk5ldHdvcmsuUHJvdG8uQ2hpbGRRdWVzdBIT",
            "Cgtpc19maW5pc2hlZBgBIAEoCBJSCgx0aW1lX3Zhcl9tYXAYAiADKAsyPC5X",
            "ZWVkd2Fja2VyLlNoYXJlZC5OZXR3b3JrLlByb3RvLlBhcmVudFF1ZXN0LlRp",
            "bWVWYXJNYXBFbnRyeRIbChNVbmszMzAwX1BDSUhKTFBQSE5KGA4gASgNGjEK",
            "D1RpbWVWYXJNYXBFbnRyeRILCgNrZXkYASABKA0SDQoFdmFsdWUYAiABKA06",
            "AjgBYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Weedwacker.Shared.Network.Proto.ParentQuest), global::Weedwacker.Shared.Network.Proto.ParentQuest.Parser, new[]{ "InferencePageList", "QuestVar", "CutsceneEncryptionKey", "ParentQuestState", "RandomInfo", "ParentQuestId", "IsRandom", "ChildQuestList", "IsFinished", "TimeVarMap", "Unk3300PCIHJLPPHNJ" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, })
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ParentQuest(ParentQuest other) : this() {
      ...
      cutsceneEncryptionKey_ = other.cutsceneEncryptionKey_;
    ...
    /// <summary>Field number for the "cutscene_encryption_key" field.</summary>
    public const int CutsceneEncryptionKeyFieldNumber = 11;
    private ulong cutsceneEncryptionKey_;
    /// <summary>
    /// video_key
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public ulong CutsceneEncryptionKey {
      get { return cutsceneEncryptionKey_; }
      set {
    ...
    public bool Equals(ParentQuest other) {
      ...
      if (CutsceneEncryptionKey != other.CutsceneEncryptionKey) return false;
    ...
    public override int GetHashCode() {
      ...
      if (CutsceneEncryptionKey != 0UL) hash ^= CutsceneEncryptionKey.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (CutsceneEncryptionKey != 0UL) {
        output.WriteRawTag(88);
        output.WriteUInt64(CutsceneEncryptionKey);
      }
      if (IsRandom != false) {
    ...
    public int CalculateSize() {
      ...
      if (CutsceneEncryptionKey != 0UL) {
        size += 1 + pb::CodedOutputStream.ComputeUInt64Size(CutsceneEncryptionKey);
      }
      if (ParentQuestState != 0) {
    ...
    public void MergeFrom(ParentQuest other) {
      ...
      if (other.CutsceneEncryptionKey != 0UL) {
        CutsceneEncryptionKey = other.CutsceneEncryptionKey;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 88: {
            CutsceneEncryptionKey = input.ReadUInt64();
            break;
          }
          case 96: {
