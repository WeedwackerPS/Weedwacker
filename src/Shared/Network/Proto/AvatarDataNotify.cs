...
namespace Weedwacker.Shared.Network.Proto {
    ...
    static AvatarDataNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bmZvLnByb3RvGhBBdmF0YXJUZWFtLnByb3RvIo4EChBBdmF0YXJEYXRhTm90",
            ...
            "GgoSb3duZWRfY29zdHVtZV9saXN0GAUgAygNEhcKD2N1c3RvbV90ZWFtX2lk",
            "cxgDIAMoDRphChJBdmF0YXJUZWFtTWFwRW50cnkSCwoDa2V5GAEgASgNEjoK",
            "BXZhbHVlGAIgASgLMisuV2VlZHdhY2tlci5TaGFyZWQuTmV0d29yay5Qcm90",
            "by5BdmF0YXJUZWFtOgI4AWIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Weedwacker.Shared.Network.Proto.AvatarDataNotify), global::Weedwacker.Shared.Network.Proto.AvatarDataNotify.Parser, new[]{ "AvatarList", "AvatarRenameList", "CurAvatarTeamId", "OwnedFlycloakList", "TempAvatarGuidList", "ChooseAvatarGuid", "AvatarTeamMap", "OwnedCostumeList", "CustomTeamIds" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, })
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public AvatarDataNotify(AvatarDataNotify other) : this() {
      ...
      customTeamIds_ = other.customTeamIds_.Clone();
    ...
    /// <summary>Field number for the "custom_team_ids" field.</summary>
    public const int CustomTeamIdsFieldNumber = 3;
    private static readonly pb::FieldCodec<uint> _repeated_customTeamIds_codec
        = pb::FieldCodec.ForUInt32(26);
    private readonly pbc::RepeatedField<uint> customTeamIds_ = new pbc::RepeatedField<uint>();
    /// <summary>
    /// backup_avatar_team_order_list
    /// </summary>
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pbc::RepeatedField<uint> CustomTeamIds {
      get { return customTeamIds_; }
    }
    ...
    public bool Equals(AvatarDataNotify other) {
      ...
      if(!customTeamIds_.Equals(other.customTeamIds_)) return false;
    ...
    public override int GetHashCode() {
      ...
      hash ^= customTeamIds_.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      customTeamIds_.WriteTo(output, _repeated_customTeamIds_codec);
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      customTeamIds_.WriteTo(ref output, _repeated_customTeamIds_codec);
    ...
    public int CalculateSize() {
      ...
      size += customTeamIds_.CalculateSize(_repeated_customTeamIds_codec);
      if (_unknownFields != null) {
    ...
    public void MergeFrom(AvatarDataNotify other) {
      ...
      customTeamIds_.Add(other.customTeamIds_);
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26:
          case 24: {
            customTeamIds_.AddEntriesFrom(input, _repeated_customTeamIds_codec);
            break;
          }
          case 42:
          case 40: {
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 26:
          case 24: {
            customTeamIds_.AddEntriesFrom(ref input, _repeated_customTeamIds_codec);
            break;
          }
          case 42:
          case 40: {
