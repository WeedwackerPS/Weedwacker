...
namespace System.CommandLine
{
    ...
    public static class CommandExtensions
    {
        ...
        {
            return GetDefaultInvocationPipeline(command, args).Invoke(rank,console);
        }
        ...
        public static int Invoke(
            ...
            UserRank rank,
            IConsole? console = null) =>
            command.Invoke(CommandLineStringSplitter.Instance.Split(commandLine).ToArray(),rank, console);
        ...
        {
            return await GetDefaultInvocationPipeline(command, args).InvokeAsync(rank,console, cancellationToken);
        }
        ...
        public static Task<int> InvokeAsync(
            ...
            IConsole? console = null,
            CancellationToken cancellationToken = default) =>
            command.InvokeAsync(CommandLineStringSplitter.Instance.Split(commandLine).ToArray(),rank, console, cancellationToken);
