...
namespace System.CommandLine.Parsing
{
    ...
    public static class ParserExtensions
    {
        ...
        public static int Invoke(
            ...
            parser.Invoke(CommandLineStringSplitter.Instance.Split(commandLine).ToArray(), rank,console);
        ...
        public static int Invoke(
            ...
            UserRank rank,
            IConsole? console = null) =>
            parser.Parse(args).Invoke(rank,console);
        ...
        public static Task<int> InvokeAsync(
            ...
            parser.InvokeAsync(CommandLineStringSplitter.Instance.Split(commandLine).ToArray(),rank, console, cancellationToken);
        ...
        public static async Task<int> InvokeAsync(
            ...
            IConsole? console = null,
            CancellationToken cancellationToken = default) =>
            await parser.Parse(args).InvokeAsync(rank ,console, cancellationToken);
