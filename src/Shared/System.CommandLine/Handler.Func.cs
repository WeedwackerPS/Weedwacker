...
{
    public static UserRank GetRequiredRank(MethodInfo mi) => mi.GetCustomAttribute<RequiredRankAttribute>().userRank;
    /// <summary>
    ...
    public static void SetHandler(
        ...
        Func<Task> handle) =>
        command.Handler = new AnonymousCommandHandler(_ => handle(), GetRequiredRank(handle.Method));
